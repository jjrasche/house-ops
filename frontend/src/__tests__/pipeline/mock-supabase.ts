...
export const VERB_TOOL_SEED: VerbToolRow[] = [
  ...
  { household_id: 1, verb: 'get',       entity_types: ['item'],            tool_name: 'update_item',    confidence: 0.94, source: 'seed' },
  { household_id: 1, verb: 'got',       entity_types: ['item'],            tool_name: 'update_item',    confidence: 0.94, source: 'seed' },
  { household_id: 1, verb: 'grab',      entity_types: ['item'],            tool_name: 'update_item',    confidence: 0.94, source: 'seed' },
  { household_id: 1, verb: 'grabbed',   entity_types: ['item'],            tool_name: 'update_item',    confidence: 0.94, source: 'seed' },
  { household_id: 1, verb: 'put',       entity_types: ['item'],            tool_name: 'update_item',    confidence: 0.93, source: 'seed' },
  { household_id: 1, verb: 'running low', entity_types: ['item'],          tool_name: 'update_item',    confidence: 0.90, source: 'seed' },
  { household_id: 1, verb: 'low on',    entity_types: ['item'],            tool_name: 'update_item',    confidence: 0.90, source: 'seed' },
  { household_id: 1, verb: 'all set',  entity_types: ['item'],            tool_name: 'update_item',    confidence: 0.90, source: 'seed' },
